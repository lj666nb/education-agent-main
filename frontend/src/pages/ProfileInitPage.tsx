    ...
    return (
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        <div className="card" style={{ textAlign: 'center', padding: '3rem' }}>
          ...
          <p style={{ color: '#6b7280', marginBottom: '2rem' }}>我们已根据您的信息生成了个性化学习画像</p>
    ...
    <div style={{ maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
          <span style={{ fontSize: '0.875rem', color: '#6b7280' }}>步骤 {step} / 5</span>
          <span style={{ fontSize: '0.875rem', color: '#6b7280' }}>{Math.round(step / 5 * 100)}%</span>
        </div>
        <div style={{ height: '4px', backgroundColor: '#e5e7eb', borderRadius: '2px' }}>
          <div style={{ height: '100%', backgroundColor: '#3b82f6', width: `${(step / 5) * 100}%`, borderRadius: '2px', transition: 'width 0.3s' }} />
        </div>
      </div>
      ...
      <div className="card">
        {step === 1 && (
          <>
            ...
            <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>请告诉我们您的专业和年级</p>
        ...
        {step === 2 && (
          <>
            ...
            <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>您希望通过这个系统达成什么目标？</p>
            <div style={{ marginBottom: '1.5rem' }}>
        ...
        {step === 3 && (
          <>
            ...
            <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>请评估您在相关领域的基础水平</p>
            <div style={{ marginBottom: '1.5rem' }}>
        ...
        {step === 4 && (
          <>
            ...
            <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>您更喜欢哪种学习方式？</p>
            <div style={{ display: 'grid', gap: '0.75rem' }}>
              {[
                { value: 'visual', label: '📊 视觉型', desc: '喜欢图表、流程图、思维导图' },
                { value: 'auditory', label: '🎧 听觉型', desc: '喜欢听讲解、视频教程' },
                { value: 'reading', label: '📖 阅读型', desc: '喜欢看文档、书籍' },
                { value: 'kinesthetic', label: '💻 实践型', desc: '喜欢动手操作、敲代码' },
              ].map(option => (
                <div
                  key={option.value}
                  ...
                  style={{
                    padding: '1rem',
                    border: `2px solid ${formData.preferredStyle === option.value ? '#3b82f6' : '#e5e7eb'}`,
                    borderRadius: '0.5rem',
                    cursor: 'pointer',
        ...
        {step === 5 && (
          <>
            ...
            <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>请确认您的信息，我们将基于此构建学习画像</p>
